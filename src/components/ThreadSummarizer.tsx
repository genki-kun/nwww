    ...
    return (
        <div className={styles.container}>
            <div className={styles.header}>
                <h3 className={styles.title}>NWWW要約 (3-Line Summary)</h3>
                <span className={styles.postCountBadge}>{postCount}レス</span>
            </div>
            ...
            {summary && isOpen && (
                <div className={styles.result}>
                    ...
                    <div className={styles.meta}>
                        Generated by NWWW AI • {postCount}レス時点
                    </div>
