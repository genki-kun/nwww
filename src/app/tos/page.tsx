    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.section}>
                ...
                <p className={styles.content}>
                    1. **コンテンツの権利**: ユーザーが投稿したコンテンツの著作権はユーザーに帰属します。ただし、ユーザーは本サービスに対し、コンテンツを本サービス内で無償で使用（複製、表示、改変等）する権利を許諾するものとします。{"\n"}
                    2. **削除権限**: 本サービスは、投稿コンテンツが禁止事項に抵触する場合、または運営上の理由により必要と判断した場合、事前通知なくコンテンツを削除（または「あぼーん」表示による非表示化）し、あるいはユーザーのアクセスを制限することができるものとします。{"\n"}
                    3. **AIによる分析**: 本サービスは、投稿内容をAIを使用して分析・要約・分類することがあり、ユーザーはこれに同意するものとします。
                </p>
            </div>
            ...
            <div className={styles.section}>
                ...
                <p className={styles.content}>
                    1. **コンテンツの責任**: 本サービスは、ユーザーによって投稿された内容の正確性、適法性、妥当性について一切保証しません。投稿に関する責任はすべて投稿したユーザーが負うものとします。{"\n"}
                    2. **損害賠償**: ユーザーが本サービスの利用により第三者との間で紛争が生じた場合、ユーザー自身の責任と費用で解決するものとし、本サービスは一切の責任を負いません。{"\n"}
                    3. **サービスの停止**: 本サービスは、メンテナンスやトラブル等の理由により、予告なくサービスの一部または全部を停止することがあります。
                </p>
            </div>
